{
  ...
  "integrations": [
    ...
    %{ if cloud_config.s3_enabled && cloud_config.ecr_enabled },%{ endif }
    ...
    %{ if (cloud_config.s3_enabled || cloud_config.ecr_enabled) && cloud_config.parameter_store_enabled },%{ endif }
