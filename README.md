...
| <a name="input_azure_cluster_integration_enabled"></a> [azure\_cluster\_integration\_enabled](#input\_azure\_cluster\_integration\_enabled) | Flag to enable Azure AKS cluster integration | `bool` | `false` | no |
...
| <a name="input_azure_storage_enabled"></a> [azure\_storage\_enabled](#input\_azure\_storage\_enabled) | Flag to enable Azure Blob Storage integration | `bool` | `false` | no |
